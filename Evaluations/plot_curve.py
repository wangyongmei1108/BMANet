...
styles = ['.-r', '.--b', '.--l', '.--c', '.--m', '.--o', '.--k', '.--t',
          '.-s', '.-d', '.-m', '.-g', '.-d', '.-o', '.-b', '.-t']
lines = ['-', '--', '--', '--', '--', '--', '--', '--','-', '-', '-', '-', '-', '-', '-', '-']
points = ['*', '.', '.', '.', '.', '.', '.', '.','.', '.', '.', '.', '.', '.', '.', '.']
colors = ['r', 'brown', 'lime', 'c', 'm', 'orange', 'k', 'tomato',
          'slategray','darkSalmon','maroon','gold','darkKhaki','olive','blueViolet','thistle']
methods=['BMANet','MSCNet','CorrNet','ACCoNet','LVNet','VOS','CMC','SMFF',
         'SAMNet','PoolNet','MINet','LDF','GCPA','SUCA','HDCT','DSG']
...
if __name__ == "__main__":
    ...
    parser.add_argument('--res_dir', type=str, default='../Outputs/Detail/')
    parser.add_argument('--out_dir', type=str, default='./Result/Curves/')
